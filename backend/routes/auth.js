...
router.put('/profile', authMiddleware, async (req, res) => {
  try {
    ...
    if (alertCityName !== undefined) {
      updateData.alertCityName = alertCityName;
    }
    if (age !== undefined && age !== null && age !== '') {
